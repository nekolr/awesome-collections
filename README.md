...
[![build](https://img.shields.io/github/actions/workflow/status/nekolr/awesome-collections/check_url_by_awesome_bot.yml)](https://github.com/nekolr/awesome-collections/actions/workflows/check_url_by_awesome_bot.yml)
...
- [泥瓦匠](https://www.bysocket.com/) - Java 工程师，并发网 ifeve.com 编辑。[![](/media/github.svg)](https://github.com/JeffLi1993/)
- [crossoverJie](https://crossoverjie.top/) - Java 程序员，在 Github 上特别活跃，开源过很多项目。[![](/media/github.svg)](https://github.com/crossoverJie/)
...
- [Win32/Win64 OpenSSL](https://slproweb.com/products/Win32OpenSSL.html) - openssl for windows。
...
- [Pyrexp](https://pythonium.net/regex) - 在线创建和可视化正则表达式。
